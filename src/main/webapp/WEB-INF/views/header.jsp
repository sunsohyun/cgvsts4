		...
		<div class="header_menu">
			<nav class="nav1">
				...
				<ul>
					...
					<li><a href="#">VIP</a></li>
					<li><a href="#">고객센터</a></li>
					<li><a href="http://localhost:9000/notice_list/1/">공지사항</a></li><%-- /1/ : 페이징처리해서 추가함 : 1패이지로 이동 --%>
				...
				<c:otherwise>
				<ul>
					<li>[ ${sessionScope.svo.name} ]님! 반갑습니다~</li>	<!-- a태그 사이즈 조정은 직접하기!! -->
					...
					<li><a href="http://localhost:9000/board_list/1/">게시판</a></li>
					<li><a href="http://localhost:9000/board_list_json">게시판(JSON)</a></li><%--RestController 사용하면됨--%>
					<c:if test="${sessionScope.svo.id == 'admin'}">
						<li><a href="http://localhost:9000/admin/admin_index">ADMIN</a></li>
					</c:if>
				</ul>
				</c:otherwise>
				</c:choose>
