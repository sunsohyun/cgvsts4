...
<body>
	<!-- header -->
	<!-- <iframe src="http://localhost:9000/_jsp_jsp/header.jsp"
	...
	<div class="content">
		<section class="admin">
			...
			<div>
				<article><a href="/admin/admin_notice_list/1/">🛕 공지사항 관리</a></article>
	...
	<!-- footer -->
	<!-- <iframe src="http://localhost:9000/_jsp_jsp/footer.jsp"
